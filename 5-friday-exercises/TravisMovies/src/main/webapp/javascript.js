...
function clickSubAll() {
    allUsers = fetch("/TravisMovies/api/movies/all")
            .then(res => res.json())
            .then(data => {
                funcAll(data);
            })
...
function clickSubId() {
    fetch("/TravisMovies/api/movies/" + document.getElementById("addId").value)
            .then(res => res.json())
            .then(data => {
                data;
                funcId(data);
...
function clickSubName() {
    fetch("/TravisMovies/api/movies/name/" + document.getElementById("addName").value)
            .then(res => res.json())
            .then(data => {
                data;
                funcName(data);
